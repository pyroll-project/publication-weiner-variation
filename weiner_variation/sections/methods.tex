...
A \qty{50}{\milli\meter} round workpiece made of C45 carbon steel is rolled down to \qty{8}{\milli\meter} diameter.
Details of the schedule are provided in \autoref{tab:process_conditions} and \autoref{tab:workpiece}, as well as in the supplemental material~\cite{WeinerVariationSupplemental2023}.
...
\begin{table}
    ...
    \begin{subtable}{\linewidth}
        \centering
        \caption{Flow Stress Parameters acc.~to~\cite{Spittel2009}}
        \label{tab:flow_stress}
        \input{tbl/flow_stress}
    \end{subtable}
    \caption{Principal Data of the Input Workpiece}
    \label{tab:workpiece}
\end{table}

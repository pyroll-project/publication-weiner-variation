...
\begin{enumerate}
    \item What is the difference in the behavior of variations sourced in the input workpiece and arising within the process (manual handling)?
...
Together with the variational behavior of the process, these determine the variation of the resulting product.
...
The uncertainty of the input workpiece was modelled using normal distributions for diameter and mean temperature, with expectation equal to the nominal values (\qty{50}{\milli\meter} and \qty{1200}{\celsius}) and standard deviations of \qty{1}{\milli\meter} resp.~\qty{10}{\kelvin}.

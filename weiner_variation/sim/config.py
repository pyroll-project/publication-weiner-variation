...
FIELDS = {
    ...
    "heat_turnover": lambda u: (u.temperature_change_by_deformation - u.temperature_change_by_contact) * u.in_profile.density * u.in_profile.specific_heat_capacity * u.volume,

...
PASS_SEQUENCE = pr.PassSequence(
    [
        ...
        pr.Transport(duration=REVERSING_PAUSE_DURATION),
        pr.RollPass(
            label="R2",
            roll=pr.Roll(
        ...
        pr.Transport(duration=LAST_REVERSING_PAUSE_DURATION),
        pr.RollPass(
            label="F1",
            roll=pr.Roll(
        ...
        pr.Transport(duration=1.5 / 7.9),
        pr.RollPass(
            label="F2",
            roll=pr.Roll(
                groove=pr.RoundGroove(r1=0.5e-3, r2=5.1e-3, depth=(10e-3 - 1.5e-3) / 2),
                nominal_radius=107.5e-3,
            ),
            velocity=9.3,
            gap=1.5e-3,
        ),
        pr.Transport(duration=1.5 / 9.3),
        pr.RollPass(
            label="F3",
            roll=pr.Roll(
                groove=pr.CircularOvalGroove(
        ...
        pr.Transport(duration=1.5 / 12.06),
        pr.RollPass(
            label="F4",
            roll=pr.Roll(
                groove=pr.RoundGroove(r1=0.5e-3, r2=4.1e-3, depth=(8e-3 - 1.5e-3) / 2),

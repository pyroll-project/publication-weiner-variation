...
from weiner_variation.config import BUILD_DIR, DATA_DIR, ROOT_DIR
...
def task_pause_distributions(template=TEMPLATE, data=DATA_DIR / "duo_pauses_dist.csv", produces=RESULT):
